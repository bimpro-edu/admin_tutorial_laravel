...
@section('page-title', __('Hồ sơ của tôi'))
@section('page-heading', __('Hồ sơ của tôi'))
...
@section('scripts')
    ...
    {!! JsValidator::formRequest('ThaoHR\Http\Requests\User\UpdateDetailsRequest', '#details-form') !!}
    {!! JsValidator::formRequest('ThaoHR\Http\Requests\User\UpdateProfileLoginDetailsRequest', '#login-details-form') !!}

    @if (setting('2fa.enabled'))
        {!! JsValidator::formRequest('ThaoHR\Http\Requests\TwoFactor\EnableTwoFactorRequest', '#two-factor-form') !!}
    @endif
@stop
