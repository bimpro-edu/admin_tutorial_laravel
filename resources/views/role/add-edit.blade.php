...
@section('scripts')
    @if ($edit)
        {!! JsValidator::formRequest('ThaoHR\Http\Requests\Role\UpdateRoleRequest', '#role-form') !!}
    @else
        {!! JsValidator::formRequest('ThaoHR\Http\Requests\Role\CreateRoleRequest', '#role-form') !!}
    @endif
@stop
