...
<div class="col-md-8 col-lg-6 col-xl-5 mx-auto my-10p">
    <div class="text-center">
        <img src="{{ url('assets/img/eflare_logo.png') }}" alt="{{ setting('app_name') }}" height="100">
    </div>
...
@section('scripts')
    {!! JsValidator::formRequest('ThaoHR\Http\Requests\Auth\PasswordRemindRequest', '#remind-password-form') !!}
@stop
