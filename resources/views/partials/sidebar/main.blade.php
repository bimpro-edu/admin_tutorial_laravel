<nav class="col-md-2 sidebar">
    ...
    <div class="sidebar-sticky">
        <ul class="nav flex-column">
            @foreach (\ThaoHR\Plugins\ThaoHR::availablePlugins() as $plugin)
                @if(get_class($plugin) !=  \ThaoHR\UserActivity\UserActivity::class && get_class($plugin) !=  \ThaoHR\Announcements\Announcements::class)
