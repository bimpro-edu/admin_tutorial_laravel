<nav class="navbar fixed-top align-items-start navbar-expand-lg pl-0 pr-0 py-0" >
    ...
    <div class="navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <a class="navbar-brand mr-0" href="{{ url('/') }}">
            <img src="{{ url('assets/img/logo.png') }}" class="logo-lg" height="30" alt="{{ setting('app_name') }}">
            <img src="{{ url('assets/img/logo.png') }}" class="logo-sm" height="30" alt="{{ setting('app_name') }}">
        </a>
    </div>
    ...
    <div class="collapse navbar-collapse" id="top-navigation">
        ...
        <ul class="navbar-nav ml-auto pr-3 flex-row">
            ...
            @include('announcement.partials.navbar.list')
