...
class UserEventsSubscriberTest extends ListenerTestCase
{
    ...
    {
        parent::setUp();
        $this->theUser = factory(\ThaoHR\User::class)->create();
    }

    /** @test */
    public function onLogin()
    {
        event(new \ThaoHR\Events\User\LoggedIn);
    ...
    {
        event(new \ThaoHR\Events\User\LoggedOut());
    ...
    public function onRegister()
    {
        ...
        $user = factory(\ThaoHR\User::class)->create();
    ...
    {
        event(new \ThaoHR\Events\User\ChangedAvatar);
    ...
    {
        event(new \ThaoHR\Events\User\UpdatedProfileDetails);
    ...
    {
        event(new \ThaoHR\Events\User\Deleted($this->theUser));
    ...
    {
        event(new \ThaoHR\Events\User\Banned($this->theUser));
    ...
    {
        event(new \ThaoHR\Events\User\UpdatedByAdmin($this->theUser));
    ...
    {
        event(new \ThaoHR\Events\User\Created($this->theUser));
    ...
    {
        event(new \ThaoHR\Events\Settings\Updated);
    ...
    {
        event(new \ThaoHR\Events\User\TwoFactorEnabled);
    ...
    {
        event(new \ThaoHR\Events\User\TwoFactorDisabled);
    ...
    {
        event(new \ThaoHR\Events\User\TwoFactorEnabledByAdmin($this->theUser));
    ...
    {
        event(new \ThaoHR\Events\User\TwoFactorDisabledByAdmin($this->theUser));
    ...
    {
        event(new \ThaoHR\Events\User\RequestedPasswordResetEmail($this->user));
    ...
    {
        $impersonated = factory(\ThaoHR\User::class)->create([
            'first_name' => 'John',
            'last_name' => 'Doe'
        ]);
