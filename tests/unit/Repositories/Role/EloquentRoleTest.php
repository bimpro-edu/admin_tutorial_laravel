...
class EloquentRoleTest extends TestCase
{
    ...
    {
        $this->expectsEvents(\ThaoHR\Events\Role\Updated::class);
    ...
    {
        $this->expectsEvents(\ThaoHR\Events\Role\Deleted::class);
    ...
    {
        $role = factory(Role::class)->create();
        $permissions = factory(\ThaoHR\Permission::class)->times(2)->create();
