    ...
    class Artisan {
        ...
        public static function handle($input, $output = null)
        {
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
                        /** @var \ThaoHR\Console\Kernel $instance */
...
namespace ThaoHR\Services\Auth\TwoFactor { 
    ...
    class Facade {
         ...
         *
         * @param \ThaoHR\Services\Auth\TwoFactor\TwoFactorAuthenticatable $user
         * @return bool 
         * @static 
         */ 
        public static function isEnabled($user)
        {
                        /** @var \ThaoHR\Services\Auth\TwoFactor\Authy $instance */
         ...
         *
         * @param \ThaoHR\Services\Auth\TwoFactor\Contracts\Authenticatable $user
         * @return mixed 
         * @static 
         */ 
    ...
    class JWTAuth {
        ...
        public static function attempt($credentials)
        {
            //Method inherited from \Tymon\JWTAuth\JWTAuth            
                        /** @var \ThaoHR\Services\Auth\Api\JWTAuth $instance */
         ...
         *
         * @param bool $forceForever
         * @return \ThaoHR\Services\Auth\Api\JWTAuth 
         * @static 
         */ 
...
namespace  { 
    ...
    class Authy extends \ThaoHR\Services\Auth\TwoFactor\Facade {}
