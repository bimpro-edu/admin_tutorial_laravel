...
namespace ThaoHR\Repositories\User;

use ThaoHR\Repositories\Role\RoleRepository;
use ThaoHR\Role;
use ThaoHR\Services\Auth\Social\ManagesSocialAvatarSize;
...
class EloquentUser implements UserRepository
{
     ...
     * 
     * {@inheritDoc}
     * @see \ThaoHR\Repositories\User\UserRepository::all()
     */
    public function list()
    {
        ...
        foreach ($users as $user) {
            $results[$user->id] = $user->fullName().'('.$user->role->display_name.')';
        }
