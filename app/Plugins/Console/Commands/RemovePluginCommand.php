...
namespace ThaoHR\Plugins\Console\Commands;

use Symfony\Component\Process\Exception\ProcessFailedException;
use Symfony\Component\Process\Process;
use ThaoHR\Plugins\ThaoHR;
...
class RemovePluginCommand extends PluginCommand
{
     ...
     * @var string
     */
    protected $name = 'thaohr:remove-plugin';
    ...
    public function handle()
    {
        ...
        if ($this->pluginIsStillActive()) {
            ...
            $message .= " plugins inside the ThaoHRServiceProvider first.";
            $this->error($message);
            return;
        }
    ...
    private function pluginIsStillActive()
    {
        ...
        return isset(ThaoHR::availablePlugins()[$pluginClassName]);
    }
